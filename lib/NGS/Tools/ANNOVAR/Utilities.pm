...
A set of utilities to use with the ANNOVAR suite of tools.
...
Convert a VCF file to an ANNOVAR compatible input format.
...
sub convert_vcf_to_annovar_input {
	...
	while(my $vcf_entry = $vcf->next_data_hash()) {
